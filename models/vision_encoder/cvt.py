...
from models.vision_encoder.ext.cvt.models import build_model
from models.vision_encoder.ext.cvt.config.default import _update_config_from_file
from models.vision_encoder.ext.cvt.config.default import _C as config
...
class CvT(Module):
    ...
    def __init__(
        ...
        Argument/s:
            ...
            ckpt_path - path containing the pre-trained model checkpoints.
        ...
        # CvT
        args = Namespace(
            cfg=os.path.join("models", "vision_encoder", "ext", "cvt", "experiments", "imagenet", "cvt", model_config + ".yaml"))
    ...
    def forward(self, images: torch.FloatTensor):
        ...
        outputs = outputs["last_hidden_state"].permute(0, 2, 1)  # (b, 576, 384)
        return outputs, cls_tokens.squeeze(dim=1)
