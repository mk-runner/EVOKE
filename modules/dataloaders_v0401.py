...
from .datasets_v0401 import MimiccxrPretrainInferenceBaseDataset
from .datasets_v0401 import MimiccxrPretrainInferenceDatasetOne
from .datasets_v0401 import MimiccxrPretrainDataset, IuxrayPretrainDataset
# from .datasets_v0401 import MimiccxrFinetuneDataset, IuxrayFinetuneDataset
...
class PretrainInferenceLoader(DataLoader):
    def __init__(self, args, tokenizer, split, shuffle, drop_last=None):
        ...
        if args['data_name'] == 'iu_xray':
            ...
            self.dataset = MimiccxrPretrainInferenceBaseDataset(args, tokenizer, self.split, transform=None)
        else:
            raise ValueError
