...
def build_my_tokenizer(tokenizer_dir: str = 'config/tokenizer', model: str = 'wordlevel', data_name: str = 'mimic_cxr',
                       ann_path: str = None, tokenizer_type='uncased', is_same_tokenizer: bool = False):
    model = model.lower()
