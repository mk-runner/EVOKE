...
class PretrainDataset(Dataset):  # finetune and inference phase
    ...
    def __getitem__(self, idx):
        ...
        sample = (image_id, example['image_path'], radgraph_ids, radgraph_masks, radgraph_len)
        return sample
...
class FinetuneHasIndication(Dataset):  # finetune and inference phase
    ...
    def __getitem__(self, idx):
        ...
        sample = (image_id, example['image_path'], report_ids, report_masks, report_len, inc_ids, inc_masks, inc_len)
        return sample
...
class FinetuneNotIndication(Dataset):  # finetune and inference phase
    ...
    def __getitem__(self, idx):
        ...
        sample = (image_id, example['image_path'], report_ids, report_masks, report_len)
        return sample
