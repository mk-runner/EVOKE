...
class BaseTrainer(object):
    ...
    def _load_checkpoint(self, load_path):
        ...
        # only load parameters with same model name and shape
        model_dict = self.model.state_dict()
        pretrain_dict = {k: v for k, v in checkpoint['state_dict'].items() if k in model_dict and v.shape == model_dict[k].shape}
