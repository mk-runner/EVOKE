...
def setup_arguments():
    ...
    parse.add_argument('--mimic_cxr_ann_path', type=str,
                       default='/home/miao/data/dataset/MIMIC-CXR/mimic_cxr_annotation_sen_best_reports_keywords_20_multiview_individual_v0331.json'
                       )
    parse.add_argument('--mimic_cxr_image_dir', type=str, default='/home/miao/data/dataset/MIMIC-CXR/files/')
    # parse.add_argument('--text_decoder', type=str, choices=['r2gen', 'distilgpt2'], default='distilgpt2')
    # parse.add_argument('--visual_encoder', type=str, choices=['resnet101'], default='resnet101')
    parse.add_argument('--tokenizer_dir', type=str, default='config/tokenizer/')
    parse.add_argument('--tokenizer_type', type=str, default='uncased')
    ...
    parse.add_argument('--is_multiview_learning', type=str2bool, default='yes',
                       help='whether conducting multiview learning')
    parse.add_argument('--is_add_indication', type=str2bool, default='yes',
                       help='whether conducting multiview learning')
    # parse.add_argument('--sk_type', type=str, choices=['report', 'keywords'], default='keywords')
    # parse.add_argument('--sk_topk', type=int, default=0)
    ...
    parse.add_argument('--num_layers', type=int, default=3, help='the number of text decoder layers')
    # parse.add_argument('--sk_file_name', type=str, default='_v0107_')
    # trainer configuration
    parse.add_argument('--optim', type=str, choices=['AdamW', 'RAdam'], default='RAdam',
                       help='in the first stage, the optimization is AdamW with lr=5.0e-5, and in the second stage, optimizer is RAdam')
    ...
    parse.add_argument('--pt_lr', type=float, default=5.0e-6,
                       help='learning rate of the main parameters in the pretrain stage')  # 5.0e-5
    parse.add_argument('--ft_lr', type=float, default=5.0e-5,
                       help='learning rate of the main parameters in the finetune stage')  # 5.0e-5
    ...
    #                    default='/home/miao/data/dataset/checkpoints/distilbert/distilgpt2')  # choices={metrics, RC, RB, RCB}
    ...
    parse.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.',
                       # default='/home/miao/data/Code/Second/results/mimic_cxr/pretrain/v0411_pt/checkpoint/model_best.pth'
                       )
    parse.add_argument('--load', type=str, help='whether to load the pre-trained model.',
                       # default='/home/miao/data/Code/Second/results/mimic_cxr/pretrain/v0411_v0416_pt/checkpoint/model_best.pth'
                       default="/home/miao/data/Code/EVOKE/results/mimic_cxr/finetune/ft_v0623_large/checkpoint/model_best.pth"
                       )
    ...
    logger = SetLogger(f'{args["result_dir"]}/{args["task"]}.log', 'a')
